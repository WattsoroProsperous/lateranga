...
import { ArrowLeft, Clock, Check, ChefHat, Package, XCircle, CreditCard, UtensilsCrossed } from "lucide-react";
...
export function TableOrdersView({ table, session, orders, tableToken }: TableOrdersViewProps) {
      ...
      <main className="max-w-lg mx-auto px-4 py-6 space-y-6">
        ...
        {orders.length > 0 ? (
          ...
          <div className="text-center py-16">
            ...
            <Button onClick={() => router.push(`/table/${tableToken}/menu`)}>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 p-4 bg-gradient-to-t from-background via-background to-transparent">
        <div className="max-w-lg mx-auto">
          <Button
            ...
            size="lg"
            onClick={() => router.push(`/table/${tableToken}/menu`)}
          >
